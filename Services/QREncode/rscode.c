 ...
 *
 * The memset() and memmove() functions are used. The appropriate header file
 * declaring these functions (usually <string.h>) must be included by the calling program.
 *
 * Copyright 2004, Phil Karn, KA9Q
 * May be used under the terms of the GNU Lesser General Public License (LGPL)
 */
