 ...
 *
 * This file is part of PeerProject (peerproject.org) ©2015
 ...
 * object. In order to generate structured-appended symbols, it is required
 * to embed headers to each symbol. You can use
 * QRinput_Struct_insertStructuredAppendHeaders() to insert appropriate headers
 * to each symbol. You should call this function just once before encoding symbols.
 */
...
/**
 * Maximum version (size) of MQR-code symbol.
 */
 ...
 * @return an input object (initialized). On error, NULL is returned and errno is set to indicate the error.
 ...
 * @retval 0 success.
 * @retval -1 an error occurred and errno is set to indeicate the error. See Execptions for the details.
 * @throw ENOMEM unable to allocate memory.
 ...
 * @return an instance of QRinput_Struct. On error, NULL is returned and errno is set to indicate the error.
 * @throw ENOMEM unable to allocate memory.
 */
...
/**
 * Append a QRinput object to the set. QRinput created by QRinput_newMQR() will be rejected.
...
/**
 * Split a QRinput to QRinput_Struct. It calculates a parity, set it,
 * then insert structured-append headers. QRinput created by QRinput_newMQR() will be rejected.
 * @param input input object. Version number and error correction level must be set.
 * @return a set of input data. On error, NULL is returned, and errno is set to indicate the error. See Exceptions for the details.
 ...
 * @param version version of the symbol. If 0, the library chooses the minimum version for the given input data.
 * @param level error correction level.
 * @throw EINVAL invalid input object.
 * @throw ENOMEM unable to allocate memory for input objects.
 * @throw ERANGE input data is too large.
...
/**
 * Return a string that identifies the library version.
 * @return a string identifies the library version. The string is held by the library.
 * Do NOT free it.
 */
