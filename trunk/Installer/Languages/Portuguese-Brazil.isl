; Inno Setup 5.1.11+ Portuguese (Brazil) Messages (PeerProject: pt-br)
;
; Original Author: Paulo Andre Rosa (parosa@gmail.com)
; Maintainer:   Jeferson Oliveira (jefersonfoliveira@gmail.com)
; Contributors: Felipe (felipefpl@ig.com.br)
;
