...
0. This PeerProject sourcecode is self-contained.


1. Install Microsoft Visual Studio
	(2008/2010 or Visual C++ Express)

2. Install Windows 2008 SDK  (6.1 compiler required)
...
0. This PeerProject sourcecode package contains files under several licenses. READ THEM.


1. All code is GPL 2/3, except where specifically noted. (See Services)
...
2. All original visual resources are Creative Commons BY-NC-SA.
	(Images = Attribution, Non-Commercial, Share-Alike.)
...
Some portions previously copyright Shareaza Development Team, and others. (Services respectively)