<html>
	<head>
		...
		<title>PeerProject Collection File(GeneralPurpleCollection)</title>
		<style>
		p,div,td
		{
			font-family: Verdana;
...
function onMouseOut(el)
{
	...
	<body text="white" bgColor="#300000" leftMargin="0" topMargin="0">
		<table width="100%" cellpadding="0" cellspacing="0" height="56" background="title_back.gif">
			<tr>
				<td width="78"><a href="http://peerproject.org/?id=download"><img src="icon.gif" width="72" height="72" border="0" alt="Download PeerProject"></a></td>
