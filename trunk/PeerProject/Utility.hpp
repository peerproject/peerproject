...
//! \file       Utility.hpp
//! \brief      Defines some global helper types and functions.
...
// we use typedef instead of a using declaration because otherwise doxygen will omit it:
//! \brief alias for std::size_t.
typedef std::size_t size_t;
//! \brief alias for std::ptrdiff_t.
typedef std::ptrdiff_t ptrdiff_t;

//! \brief alias for CString.
...
typedef DWORD DWORD_PTR_ARG;
typedef DWORD DWORD_PTR_RESULT;
#else
...
#endif // #ifndef UTILITY_HPP_INCLUDED
