...
//
// The perl_syntax class encapsulates the Perl 5 regular expression syntax.
// It is used as a template parameter to basic_rpattern.  To customize regex syntax,
// create your own syntax class and use it as a template parameter instead.
//
