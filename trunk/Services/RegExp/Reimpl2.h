...
//
// Description: Turn the escape sequnces \f \n \r \t \v \\ into their ASCII
//              character equivalents.  Optionally process perl escape sequences.
//
// Returns:     void
//
...
//
// Notes:       When fPattern is true, the perl escape sequences are not processed.
//              If there is an octal or hex excape sequence, we don't want to
//              turn it into a regex metacharacter here.  Leave it unescaped
//              so the regex parser correctly interprets it as a literal character.
//
