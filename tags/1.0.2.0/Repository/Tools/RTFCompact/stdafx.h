...
#ifndef _WIN32_WINDOWS		// Allow use of features specific to Windows XP or later. (98=0x0410)
#define _WIN32_WINDOWS 0x0501	// Change this to the appropriate value to target Windows Vista or later.
#endif
