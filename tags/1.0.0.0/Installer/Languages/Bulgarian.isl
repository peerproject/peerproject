; *** Inno Setup version 5.5.0+ Bulgarian Messages (PeerProject: none)
;
...
; Ако езикът, на който превеждате, изисква специална гарнитура или размер на шрифта,
; извадете от коментар съответните записи по-долу и ги променете според вашите нужди.
;DialogFontName=
;DialogFontSize=8
...
; Потребителските съобщения по-долу не се ползват от самия инсталатор,
; но ако ползвате такива в скриптовете си, вероятно бихте искали да ги преведете.
