...
// Create a boolean Metafunction to detect a nested template member.
// This implementation is based on a USENET newsgroup's posting
// by Aleksey Gurtovoy (comp.lang.c++.moderated, 2002-03-19),
