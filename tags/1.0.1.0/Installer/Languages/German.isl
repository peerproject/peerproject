...
CannotInstallToUNCPath=Das Setup kann nicht in einen UNC-Pfad installieren.
...
ApplicationsFound=Die folgenden Anwendungen benutzen Dateien, die upgedated werden müssen. Es wird empfohlen, Setup zu erlauben, diese Anwendungen zu schliessen.
ApplicationsFound2=Die folgenden Anwendungen benutzen Dateien, die upgedated werden müssen. Es wird empfohlen, Setup zu erlauben, diese Anwendungen zu schliessen. Nachdem die Installation fertiggestellt wurde, versucht Setup diese Anwendungen wieder zu starten.
