...
#define TYPE_ARRAY         6
//
// Helper macro to find out the type of an array element or expression.
// TypeOf standard function only allows identifier as its parameter.
// Use this macro to convert an expression to identifier.
//
...
// EncodeVer
//
// Encodes given four version elements to a 32 bit integer number
// (8 bits for each element, i.e. elements must be within 0...255 range).
//
...
// FindSection
//
// Returns index of the line following the header of the section.
// This macro is intended to be used with #insert directive.
//
...
// FindSectionEnd
//
// Returns index of the line following last entry of the section.
// This macro is intended to be used with #insert directive.
//
#if VER >= 0x03000000
...
// ChangeFileExt
//
// Changes extension in FileName with NewExt. NewExt must not contain period.
//
