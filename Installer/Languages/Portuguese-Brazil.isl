; *** Inno Setup 5.5.0+ Portuguese (Brazil) Messages (PeerProject: pt-br)
;
; Original Author: Paulo Andre Rosa (parosa@gmail.com)
; Maintainer:	Eduardo Mauro (emauro@acabit.com.br
; Contributor:	Jeferson Oliveira (jefersonfoliveira@gmail.com)
; Contributor:	Felipe (felipefpl@ig.com.br)
;
; $jrsoftware: issrc/Files/Languages/BrazilianPortuguese.isl
;
...
WindowsServicePackRequired=Este programa requer %1 Service Pack %2 ou superior.
...
AutoStartProgram=Automaticamente iniciar %1
