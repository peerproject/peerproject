...
int CQueryHashTable::AddFile(const CPeerProjectFile& oFile)
{
	if ( ! m_pHash )
		return 0;
...
int CQueryHashTable::AddHashes(const CPeerProjectFile& oFile)
{
	if ( ! m_pHash )
		return 0;
...
int CQueryHashTable::AddExact(LPCTSTR pszString, int nStart, int nLength)
{
	if ( ! nLength )
		return 0;
