...
//
// This is the main application source file, which was generated automatically. 
// Important items are commented.
//
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
	if ( dwReason == DLL_PROCESS_ATTACH )
	{
		...
		// PeerProject creates and destroys threads, which we don't want.
	}
