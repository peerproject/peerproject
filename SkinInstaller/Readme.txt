...
1.0.7:
 ...
 - Added right click + "Install PeerProject Skin" context menu item
 - Maximized state of PeerProject is preserved when opening options
...
1.0.8
 ...
 - [.1] PeerProject window is brought to the front on configure or skin apply
